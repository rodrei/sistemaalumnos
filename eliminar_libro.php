...
<body>
  ...
  <?php  
	...
	$query = "DELETE FROM usuariolibro WHERE LibroID = '$id'" or die("Error in the consult.." . mysqli_error($dbc));
	$result = mysqli_query($dbc, $query);
	
	echo 'la query 1 es: ' . $query;
	
	$query = "DELETE FROM libros WHERE LibroID = '$id'" or die("Error in the consult.." . mysqli_error($dbc));
	$result = mysqli_query($dbc, $query);
